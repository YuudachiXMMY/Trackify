...
const AVOCADO_TOAST =
  "https://images.unsplash.com/photo-1623691751811-25db777cb59a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=400";
const GREEK_SALAD =
  "https://images.unsplash.com/photo-1601091566377-17adfa2fa02e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=400";
const SMOOTHIE =
  "https://images.unsplash.com/photo-1661257711676-79a0fc533569?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=400";
...
const CALORIES_CONSUMED = 780;
const PROTEIN_GOAL = 120;
const PROTEIN_CONSUMED = 27;
const CARBS_GOAL = 225;
const CARBS_CONSUMED = 112;
const FAT_GOAL = 60;
const FAT_CONSUMED = 25;
const WATER_GOAL = 8;
...
export function HomeScreen() {
  ...
  const name = localStorage.getItem("nourish_name") || "Alex";
  const goal =
    localStorage.getItem("nourish_goal") || "balanced";
  ...
  const caloriesLeft = CALORIE_GOAL - CALORIES_CONSUMED;
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            >
              You need <strong>93g more protein</strong> today.
              Add grilled chicken, eggs, or Greek yogurt to
              dinner.
            </p>
          </div>
        </div>
